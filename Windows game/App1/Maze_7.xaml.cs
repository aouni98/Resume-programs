...
namespace App1
{
    public sealed partial class Maze_7 : Page
    {
        //Character Character;
        Random random;
        Sword weapon;
        ...
        Enemy enemy1 = new Enemy(500, 450);
        Enemy enemy2 = new Enemy(300, 100);
        Enemy enemy3 = new Enemy(450, 100);
        Enemy enemy4 = new Enemy(450, 450);
        Enemy enemy5 = new Enemy(900, 100);
        Enemy enemy6 = new Enemy(900, 450);
        Enemy enemy7 = new Enemy(300, 250);
        private Gamepad gamepad = null;

        public Maze_7()
        {
            walls.Add(new Curtis_sRect(0, 0, 960, 20, 20));
            walls.Add(new Curtis_sRect(0, 520, 960, 20, 20));
            walls.Add(new Curtis_sRect(0, 0, 20, 270, 20));
            walls.Add(new Curtis_sRect(940, 0, 20, 550, 20));
            enemies.Add(enemy1);
            enemies.Add(enemy2);
            enemies.Add(enemy3);
            enemies.Add(enemy4);
        ...
        private async void CanvasAnimatedControl_Update(ICanvasAnimatedControl sender, CanvasAnimatedUpdateEventArgs args)
        {
            ...
            await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                if (WinningCollectable.X_Location >= Character.X_Location - 30 && WinningCollectable.Y_Location >= Character.Y_Location - 30
                 && WinningCollectable.X_Location <= Character.X_Location + 30 && WinningCollectable.Y_Location <= Character.Y_Location + 30)
                {
                    WinningCollectable.Collected = true;
                }


                
                if (Character.X_Location < 0)
                {
                    Character.X_Location = 910;

                    this.Frame.Navigate(typeof(Maze_6));
                }
