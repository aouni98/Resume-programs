...
namespace App1
{
    public sealed partial class Maze_5 : Page
    {
        //Character Character;
        Random random;
        Sword weapon;
        ...
        Enemy enemy1 = new Enemy(700, 450);
        Enemy enemy2 = new Enemy(200, 450);
        ...
        public Maze_5()
        {
            ...
            walls.Add(new Curtis_sRect(460, 0, 20, 20, 20));
            walls.Add(new Curtis_sRect(690, 0, 300, 20, 20));
            enemies.Add(enemy1);
            enemies.Add(enemy2);
