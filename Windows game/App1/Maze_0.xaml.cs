...
namespace App1
{
    ...
    /// </summary>
    public sealed partial class Maze_0 : Page
    {
       // Character Character;
        Random random;
        Sword weapon;
        ...
        public Maze_0()
        {
            ...
            walls.Add(new Curtis_sRect(940, 40, 20, 560, 20));
            walls.Add(new Curtis_sRect(0, 520, 300, 20, 20));
            walls.Add(new Curtis_sRect(650, 520, 300, 20, 20));
            walls.Add(new Curtis_sRect(0, 40, 20, 520, 20));
