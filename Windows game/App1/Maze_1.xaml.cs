...
namespace App1
{
    ...
    /// </summary>
    public sealed partial class Maze_1 : Page
    {
       // Character Character;
        Random random;
        Sword weapon;
        ...
        public Maze_1()
        {
           ...
           // Character = new Character();
            random = new Random();
            enemy = new Enemy(450, 270);
            enemies.Add(enemy);
            weapon = new Sword();
            
            walls.Add(new Curtis_sRect(0, 520, 960, 20, 20));
            walls.Add(new Curtis_sRect(0, 0, 300, 20, 20));
            walls.Add(new Curtis_sRect(650, 0, 300, 20, 20));
        ...
        private async void CanvasAnimatedControl_Update(ICanvasAnimatedControl sender, CanvasAnimatedUpdateEventArgs args)
        {
            ...
            await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                if (Character.Y_Location < 0)
                {
                    ...
                    {
                        this.Frame.Navigate(typeof(Maze_0));
                    }
                }
                if (Character.X_Location > 960)
                {
                    Character.X_Location = 50;
                    Character.Y_Location = 270;
