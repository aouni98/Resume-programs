...
namespace App1
{
    ...
    /// </summary>
    public sealed partial class Maze_2 : Page
    {
        //Character Character;
        Random random;
        Sword weapon;
        ...
        Enemy enemy = new Enemy(540,540);
        Enemy enemy1 = new Enemy(200, 150);
        ...
        public Maze_2()
        {
            ...
            walls.Add(new Curtis_sRect(480,270, 20, 270, 20));
            walls.Add(new Curtis_sRect(0, 270, 20, 270, 20));
            walls.Add(new Curtis_sRect(940, 270, 20, 270, 20));
            walls.Add(new Curtis_sRect(480, 540, 240, 20, 20));
            enemies.Add(enemy);
            enemies.Add(enemy1);
        ...
        private async void CanvasAnimatedControl_Update(ICanvasAnimatedControl sender, CanvasAnimatedUpdateEventArgs args)
        {
            ...
            await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                if(Character.X_Location < 0)
                {
                    ...
                    Character.Y_Location = 100;
                    this.Frame.Navigate(typeof(Maze_4));
                }
                if (Character.Y_Location > 540)
                {
                    Character.Y_Location = 50;
                    this.Frame.Navigate(typeof(Maze_3));
