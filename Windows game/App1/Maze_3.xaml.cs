...
namespace App1
{
    public sealed partial class Maze_3 : Page
    {
       // Character Character;
        Random random;
        Sword weapon;
        ...
        Enemy enemy1 = new Enemy(540, 200);
        Enemy enemy2 = new Enemy(540, 400);
    ...
    public Maze_3()
    {
        walls.Add(new Curtis_sRect(460, 0, 240, 20, 20));
        walls.Add(new Curtis_sRect(460, 270, 240, 20, 20));
            walls.Add(new Curtis_sRect(460, 0, 20, 270, 20));
            walls.Add(new Curtis_sRect(940, 0, 20, 540, 20));
            walls.Add(new Curtis_sRect(0, 270, 20, 540, 20));
            walls.Add(new Curtis_sRect(0,530, 960, 20, 20));
            walls.Add(new Curtis_sRect(0, 0, 20, 20, 20));
            enemies.Add(enemy1);
            enemies.Add(enemy2);
